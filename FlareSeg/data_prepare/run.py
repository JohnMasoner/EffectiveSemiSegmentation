...
if __name__ == '__main__':
    ...
    if cfg.ENVIRONMENT.DATA_BASE_DIR is not None:
        ...
        cfg.DATA_PREPARE.UNLABEL_SERIES_IDS_TXT = cfg.ENVIRONMENT.DATA_BASE_DIR + cfg.DATA_PREPARE.UNLABEL_SERIES_IDS_TXT
        cfg.DATA_PREPARE.TRAIN_IMAGE_DIR = cfg.ENVIRONMENT.DATA_BASE_DIR + cfg.DATA_PREPARE.TRAIN_IMAGE_DIR
        cfg.DATA_PREPARE.TRAIN_UNLABEL_DIR = cfg.ENVIRONMENT.DATA_BASE_DIR + cfg.DATA_PREPARE.TRAIN_UNLABEL_DIR
